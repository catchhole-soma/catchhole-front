...
const PRIVACY_CONTENT = [
  ...
  { title: '5. 외부 AI 처리', body: 'AI 분석을 실행하면 분석에 필요한 원고 구간과 관련 설정이 미국의 OpenAI OpCo, LLC에 암호화되어 전송됩니다. API 입력·출력은 기본적으로 OpenAI 모델 학습에 사용되지 않으며, 제공자 정책에 따라 처리 기록이 30일간 보관될 수 있습니다.' },
  { title: '6. 개인정보 문의', body: '개인정보 보호 업무 및 고충처리 담당 부서: CatchHole 운영팀\n이메일: aicatchhole@gmail.com' },
];

export function TermsModal({ onClose, initialTab = 'terms', zIndex = 300 }: Props) {
