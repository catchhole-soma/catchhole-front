...
export function EpisodeDeleteModal({
  ...
  const titleId = `episode-delete-title-${episode.id}`;
      ...
      >
        ...
        <div className="theme-modal__body" style={{ padding: '22px' }}>
          ...
          <div className="theme-modal__summary" style={{
            ...
            <div style={{ color: C.t1, fontSize: 13, fontWeight: 700, marginBottom: 5 }}>
              {episode.episodeNo}화 · {episode.title || '제목 없음'}
            </div>
            <div style={{
              color: C.t3,
              fontSize: 12,
              ...
              {episode.originalFilename ?? '원본 파일명 없음'}
            </div>
          </div>
