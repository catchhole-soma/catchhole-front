 ...
 * 공통 API 응답 Envelope
 */
export type CommonResponseListCharacterSummaryResponse = {
    /**
     * 요청 처리 성공 여부
     */
    success?: boolean;
     ...
     * 성공 응답 데이터. 실패 응답에서는 null입니다.
     */
    data?: Array<CharacterSummaryResponse>;
    /**
     * 에러 정보. 성공 응답에서는 null입니다.
     */
    error?: ErrorResponse;
...
export type DeleteCharacterErrors = {
     ...
     * 액세스 토큰 없음, 만료 또는 검증 실패
     */
    401: CommonResponseCharacterArchiveResponse;
    /**
     * 작품 또는 활성 캐릭터를 찾을 수 없음
     */
    404: CommonResponseCharacterArchiveResponse;
};
...
export type GetCharacterErrors = {
     ...
     * 액세스 토큰 없음, 만료 또는 검증 실패
     */
    401: CommonResponseCharacterDetailResponse;
    /**
     * 작품 또는 활성 캐릭터를 찾을 수 없음
     */
    404: CommonResponseCharacterDetailResponse;
};
...
export type UpdateCharacterErrors = {
     ...
     */
    400: CommonResponseCharacterDetailResponse;
    /**
     * 액세스 토큰 없음, 만료 또는 검증 실패
     */
    401: CommonResponseCharacterDetailResponse;
     ...
     * 같은 작품 안의 캐릭터 이름 중복
     */
    409: CommonResponseCharacterDetailResponse;
};
...
export type GetCharactersErrors = {
     ...
     * 액세스 토큰 없음, 만료 또는 검증 실패
     */
    401: CommonResponseListCharacterSummaryResponse;
    /**
     * 작품을 찾을 수 없음
     */
    404: CommonResponseListCharacterSummaryResponse;
};
...
export type GetCharactersResponses = {
     ...
     * 캐릭터 목록 조회 성공
     */
    200: CommonResponseListCharacterSummaryResponse;
};
