...
/**
 * 세계관 설정 후보 비교 대상 수정 요청
 */
export type WorldSettingCandidateUpdateRequest = {
    /**
     * 수정할 분류
     */
    category: 'RACE' | 'FACTION' | 'LOCATION' | 'MONSTER' | 'POWER_SYSTEM' | 'WORLD_RULE_HISTORY' | 'IMPORTANT_ITEM';
...
export type UpdateWorldSettingCandidateData = {
    body: WorldSettingCandidateUpdateRequest;
    path: {
        workId: string;
        candidateId: string;
    };
...
export type UpdateWorldSettingCandidateResponse = UpdateWorldSettingCandidateResponses[keyof UpdateWorldSettingCandidateResponses];
