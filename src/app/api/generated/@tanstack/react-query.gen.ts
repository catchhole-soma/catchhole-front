 ...
 */
export const retryWorldSettingCandidateComparisonMutation = (options?: Partial<Options<RetryWorldSettingCandidateComparisonData>>): UseMutationOptions<RetryWorldSettingCandidateComparisonResponse, DefaultError, Options<RetryWorldSettingCandidateComparisonData>> => {
    const mutationOptions: UseMutationOptions<RetryWorldSettingCandidateComparisonResponse, DefaultError, Options<RetryWorldSettingCandidateComparisonData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const updateWorldSettingCandidateMutation = (options?: Partial<Options<UpdateWorldSettingCandidateData>>): UseMutationOptions<UpdateWorldSettingCandidateResponse, DefaultError, Options<UpdateWorldSettingCandidateData>> => {
    const mutationOptions: UseMutationOptions<UpdateWorldSettingCandidateResponse, DefaultError, Options<UpdateWorldSettingCandidateData>> = {
        mutationFn: async (fnOptions) => {
