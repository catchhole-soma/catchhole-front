...
export const resolveWorkerWorldSettingSubjectsMutationKey = (options?: Partial<Options<ResolveWorkerWorldSettingSubjectsData>>) => createMutationKey('resolveWorkerWorldSettingSubjects', options);

/**
 * 세계관 후보 canonical 주체 해소 결과 저장
 */
export const resolveWorkerWorldSettingSubjectsMutation = (options?: Partial<Options<ResolveWorkerWorldSettingSubjectsData>>): UseMutationOptions<ResolveWorkerWorldSettingSubjectsResponse, DefaultError, Options<ResolveWorkerWorldSettingSubjectsData>> => {
    const mutationOptions: UseMutationOptions<ResolveWorkerWorldSettingSubjectsResponse, DefaultError, Options<ResolveWorkerWorldSettingSubjectsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await resolveWorkerWorldSettingSubjects({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
        ...
        mutationKey: resolveWorkerWorldSettingSubjectsMutationKey(options)
    };
    return mutationOptions;
};
 ...
 */
export const retrySettingCandidateComparisonMutation = (options?: Partial<Options<RetrySettingCandidateComparisonData>>): UseMutationOptions<RetrySettingCandidateComparisonResponse, RetrySettingCandidateComparisonError, Options<RetrySettingCandidateComparisonData>> => {
    const mutationOptions: UseMutationOptions<RetrySettingCandidateComparisonResponse, RetrySettingCandidateComparisonError, Options<RetrySettingCandidateComparisonData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const confirmSettingCandidateGroupMutation = (options?: Partial<Options<ConfirmSettingCandidateGroupData>>): UseMutationOptions<ConfirmSettingCandidateGroupResponse, ConfirmSettingCandidateGroupError, Options<ConfirmSettingCandidateGroupData>> => {
    const mutationOptions: UseMutationOptions<ConfirmSettingCandidateGroupResponse, ConfirmSettingCandidateGroupError, Options<ConfirmSettingCandidateGroupData>> = {
        mutationFn: async (fnOptions) => {
 ...
 * 작품의 내 이미지 목록
 */
export const getPrivateWorldImagesOptions = (options: Options<GetPrivateWorldImagesData>) => queryOptions<GetPrivateWorldImagesResponse, DefaultError, GetPrivateWorldImagesResponse, ReturnType<typeof getPrivateWorldImagesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
...
export const getPrivateWorldImagesInfiniteOptions = (options: Options<GetPrivateWorldImagesData>) => {
    const opts = infiniteQueryOptions<GetPrivateWorldImagesResponse, DefaultError, InfiniteData<GetPrivateWorldImagesResponse>, QueryKey<Options<GetPrivateWorldImagesData>>, number | Pick<QueryKey<Options<GetPrivateWorldImagesData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
 ...
 */
export const uploadPrivateWorldImageMutation = (options?: Partial<Options<UploadPrivateWorldImageData>>): UseMutationOptions<UploadPrivateWorldImageResponse, DefaultError, Options<UploadPrivateWorldImageData>> => {
    const mutationOptions: UseMutationOptions<UploadPrivateWorldImageResponse, DefaultError, Options<UploadPrivateWorldImageData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const getPrivateImageVaultOptions = (options?: Options<GetPrivateImageVaultData>) => queryOptions<GetPrivateImageVaultResponse, DefaultError, GetPrivateImageVaultResponse, ReturnType<typeof getPrivateImageVaultQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const createPrivateImageVaultMutation = (options?: Partial<Options<CreatePrivateImageVaultData>>): UseMutationOptions<CreatePrivateImageVaultResponse, DefaultError, Options<CreatePrivateImageVaultData>> => {
    const mutationOptions: UseMutationOptions<CreatePrivateImageVaultResponse, DefaultError, Options<CreatePrivateImageVaultData>> = {
        mutationFn: async (fnOptions) => {
...
export const claimMyFeedbackPromptMutationKey = (options?: Partial<Options<ClaimMyFeedbackPromptData>>) => createMutationKey('claimMyFeedbackPrompt', options);

/**
 * 서비스 의견 안내 노출 선점
 *
 * 노출 자격을 다시 확인하고 계정당 한 번만 안내 시각을 기록합니다. shouldShow가 true인 요청만 안내를 표시하며, 이미 선점되었거나 대상이 아니면 false를 반환합니다.
 */
export const claimMyFeedbackPromptMutation = (options?: Partial<Options<ClaimMyFeedbackPromptData>>): UseMutationOptions<ClaimMyFeedbackPromptResponse, ClaimMyFeedbackPromptError, Options<ClaimMyFeedbackPromptData>> => {
    const mutationOptions: UseMutationOptions<ClaimMyFeedbackPromptResponse, ClaimMyFeedbackPromptError, Options<ClaimMyFeedbackPromptData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await claimMyFeedbackPrompt({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
        ...
        mutationKey: claimMyFeedbackPromptMutationKey(options)
    };
    return mutationOptions;
};
 ...
 * 회원가입
 *
 * 이메일, 비밀번호, 표시 이름과 서버가 선택한 EMAIL 또는 PHONE 인증 완료 토큰으로 신규 회원을 생성합니다. 이메일과 휴대폰 번호는 각각 중복 가입을 허용하지 않습니다. 가입 완료 후 액세스 토큰은 응답 body로, 리프레시 토큰은 HttpOnly 쿠키로 발급합니다.
 */
...
export const requestEmailVerificationMutationKey = (options?: Partial<Options<RequestEmailVerificationData>>) => createMutationKey('requestEmailVerification', options);

/**
 * 이메일 인증번호 발송
 *
 * 가입되지 않은 이메일로 6자리 인증번호를 발송합니다. 기본 유효시간은 5분이며 기본 재전송 대기는 60초입니다. 실제 시간은 응답 값을 기준으로 하며 가장 최근 인증번호만 유효합니다.
 */
export const requestEmailVerificationMutation = (options?: Partial<Options<RequestEmailVerificationData>>): UseMutationOptions<RequestEmailVerificationResponse, RequestEmailVerificationError, Options<RequestEmailVerificationData>> => {
    const mutationOptions: UseMutationOptions<RequestEmailVerificationResponse, RequestEmailVerificationError, Options<RequestEmailVerificationData>> = {
        ...
        mutationKey: requestEmailVerificationMutationKey(options)
    };
    return mutationOptions;
};

export const confirmEmailVerificationMutationKey = (options?: Partial<Options<ConfirmEmailVerificationData>>) => createMutationKey('confirmEmailVerification', options);
...
export const confirmEmailVerificationMutation = (options?: Partial<Options<ConfirmEmailVerificationData>>): UseMutationOptions<ConfirmEmailVerificationResponse, ConfirmEmailVerificationError, Options<ConfirmEmailVerificationData>> => {
    const mutationOptions: UseMutationOptions<ConfirmEmailVerificationResponse, ConfirmEmailVerificationError, Options<ConfirmEmailVerificationData>> = {
        ...
        mutationKey: confirmEmailVerificationMutationKey(options)
    };
    return mutationOptions;
};
...
export const resetStaleWorkerWorldSettingSubjectResolutionMutationKey = (options?: Partial<Options<ResetStaleWorkerWorldSettingSubjectResolutionData>>) => createMutationKey('resetStaleWorkerWorldSettingSubjectResolution', options);

/**
 * 변경된 canonical 주체 해소를 다시 시작
 */
export const resetStaleWorkerWorldSettingSubjectResolutionMutation = (options?: Partial<Options<ResetStaleWorkerWorldSettingSubjectResolutionData>>): UseMutationOptions<ResetStaleWorkerWorldSettingSubjectResolutionResponse, DefaultError, Options<ResetStaleWorkerWorldSettingSubjectResolutionData>> => {
    const mutationOptions: UseMutationOptions<ResetStaleWorkerWorldSettingSubjectResolutionResponse, DefaultError, Options<ResetStaleWorkerWorldSettingSubjectResolutionData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await resetStaleWorkerWorldSettingSubjectResolution({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
        ...
        mutationKey: resetStaleWorkerWorldSettingSubjectResolutionMutationKey(options)
    };
    return mutationOptions;
};

export const failWorkerWorldSettingComparisonBatchMutationKey = (options?: Partial<Options<FailWorkerWorldSettingComparisonBatchData>>) => createMutationKey('failWorkerWorldSettingComparisonBatch', options);

/**
 * 세계관 설정 후보 묶음 비교 실패
 */
export const failWorkerWorldSettingComparisonBatchMutation = (options?: Partial<Options<FailWorkerWorldSettingComparisonBatchData>>): UseMutationOptions<FailWorkerWorldSettingComparisonBatchResponse, DefaultError, Options<FailWorkerWorldSettingComparisonBatchData>> => {
    const mutationOptions: UseMutationOptions<FailWorkerWorldSettingComparisonBatchResponse, DefaultError, Options<FailWorkerWorldSettingComparisonBatchData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await failWorkerWorldSettingComparisonBatch({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
        ...
        mutationKey: failWorkerWorldSettingComparisonBatchMutationKey(options)
    };
    return mutationOptions;
};

export const getWorkerWorldSettingComparisonBatchContextMutationKey = (options?: Partial<Options<GetWorkerWorldSettingComparisonBatchContextData>>) => createMutationKey('getWorkerWorldSettingComparisonBatchContext', options);

/**
 * 세계관 설정 후보 묶음 비교 문맥 조회
 */
export const getWorkerWorldSettingComparisonBatchContextMutation = (options?: Partial<Options<GetWorkerWorldSettingComparisonBatchContextData>>): UseMutationOptions<GetWorkerWorldSettingComparisonBatchContextResponse, DefaultError, Options<GetWorkerWorldSettingComparisonBatchContextData>> => {
    const mutationOptions: UseMutationOptions<GetWorkerWorldSettingComparisonBatchContextResponse, DefaultError, Options<GetWorkerWorldSettingComparisonBatchContextData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await getWorkerWorldSettingComparisonBatchContext({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
        ...
        mutationKey: getWorkerWorldSettingComparisonBatchContextMutationKey(options)
    };
    return mutationOptions;
};

export const completeWorkerWorldSettingComparisonBatchMutationKey = (options?: Partial<Options<CompleteWorkerWorldSettingComparisonBatchData>>) => createMutationKey('completeWorkerWorldSettingComparisonBatch', options);

/**
 * 세계관 설정 후보 묶음 비교 완료
 */
export const completeWorkerWorldSettingComparisonBatchMutation = (options?: Partial<Options<CompleteWorkerWorldSettingComparisonBatchData>>): UseMutationOptions<CompleteWorkerWorldSettingComparisonBatchResponse, DefaultError, Options<CompleteWorkerWorldSettingComparisonBatchData>> => {
    const mutationOptions: UseMutationOptions<CompleteWorkerWorldSettingComparisonBatchResponse, DefaultError, Options<CompleteWorkerWorldSettingComparisonBatchData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await completeWorkerWorldSettingComparisonBatch({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
        ...
        mutationKey: completeWorkerWorldSettingComparisonBatchMutationKey(options)
    };
    return mutationOptions;
};

export const claimNextWorkerWorldSettingComparisonBatchMutationKey = (options?: Partial<Options<ClaimNextWorkerWorldSettingComparisonBatchData>>) => createMutationKey('claimNextWorkerWorldSettingComparisonBatch', options);

/**
 * 다음 세계관 설정 후보 묶음 비교 claim
 */
export const claimNextWorkerWorldSettingComparisonBatchMutation = (options?: Partial<Options<ClaimNextWorkerWorldSettingComparisonBatchData>>): UseMutationOptions<ClaimNextWorkerWorldSettingComparisonBatchResponse, DefaultError, Options<ClaimNextWorkerWorldSettingComparisonBatchData>> => {
    const mutationOptions: UseMutationOptions<ClaimNextWorkerWorldSettingComparisonBatchResponse, DefaultError, Options<ClaimNextWorkerWorldSettingComparisonBatchData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await claimNextWorkerWorldSettingComparisonBatch({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
        ...
        mutationKey: claimNextWorkerWorldSettingComparisonBatchMutationKey(options)
    };
    return mutationOptions;
};
...
export const failWorkerCharacterFactComparisonBatchMutationKey = (options?: Partial<Options<FailWorkerCharacterFactComparisonBatchData>>) => createMutationKey('failWorkerCharacterFactComparisonBatch', options);

/**
 * 캐릭터 Fact 비교 묶음 실패
 */
export const failWorkerCharacterFactComparisonBatchMutation = (options?: Partial<Options<FailWorkerCharacterFactComparisonBatchData>>): UseMutationOptions<FailWorkerCharacterFactComparisonBatchResponse, DefaultError, Options<FailWorkerCharacterFactComparisonBatchData>> => {
    const mutationOptions: UseMutationOptions<FailWorkerCharacterFactComparisonBatchResponse, DefaultError, Options<FailWorkerCharacterFactComparisonBatchData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await failWorkerCharacterFactComparisonBatch({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
        ...
        mutationKey: failWorkerCharacterFactComparisonBatchMutationKey(options)
    };
    return mutationOptions;
};

export const getWorkerCharacterFactComparisonBatchContextMutationKey = (options?: Partial<Options<GetWorkerCharacterFactComparisonBatchContextData>>) => createMutationKey('getWorkerCharacterFactComparisonBatchContext', options);

/**
 * 캐릭터 Fact 비교 묶음 문맥 조회
 */
export const getWorkerCharacterFactComparisonBatchContextMutation = (options?: Partial<Options<GetWorkerCharacterFactComparisonBatchContextData>>): UseMutationOptions<GetWorkerCharacterFactComparisonBatchContextResponse, DefaultError, Options<GetWorkerCharacterFactComparisonBatchContextData>> => {
    const mutationOptions: UseMutationOptions<GetWorkerCharacterFactComparisonBatchContextResponse, DefaultError, Options<GetWorkerCharacterFactComparisonBatchContextData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await getWorkerCharacterFactComparisonBatchContext({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
        ...
        mutationKey: getWorkerCharacterFactComparisonBatchContextMutationKey(options)
    };
    return mutationOptions;
};

export const completeWorkerCharacterFactComparisonBatchMutationKey = (options?: Partial<Options<CompleteWorkerCharacterFactComparisonBatchData>>) => createMutationKey('completeWorkerCharacterFactComparisonBatch', options);

/**
 * 캐릭터 Fact 비교 묶음 완료
 */
export const completeWorkerCharacterFactComparisonBatchMutation = (options?: Partial<Options<CompleteWorkerCharacterFactComparisonBatchData>>): UseMutationOptions<CompleteWorkerCharacterFactComparisonBatchResponse, DefaultError, Options<CompleteWorkerCharacterFactComparisonBatchData>> => {
    const mutationOptions: UseMutationOptions<CompleteWorkerCharacterFactComparisonBatchResponse, DefaultError, Options<CompleteWorkerCharacterFactComparisonBatchData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await completeWorkerCharacterFactComparisonBatch({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
        ...
        mutationKey: completeWorkerCharacterFactComparisonBatchMutationKey(options)
    };
    return mutationOptions;
};

export const claimNextWorkerCharacterFactComparisonBatchMutationKey = (options?: Partial<Options<ClaimNextWorkerCharacterFactComparisonBatchData>>) => createMutationKey('claimNextWorkerCharacterFactComparisonBatch', options);

/**
 * 다음 캐릭터 Fact 비교 묶음 claim
 */
export const claimNextWorkerCharacterFactComparisonBatchMutation = (options?: Partial<Options<ClaimNextWorkerCharacterFactComparisonBatchData>>): UseMutationOptions<ClaimNextWorkerCharacterFactComparisonBatchResponse, DefaultError, Options<ClaimNextWorkerCharacterFactComparisonBatchData>> => {
    const mutationOptions: UseMutationOptions<ClaimNextWorkerCharacterFactComparisonBatchResponse, DefaultError, Options<ClaimNextWorkerCharacterFactComparisonBatchData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await claimNextWorkerCharacterFactComparisonBatch({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
        ...
        mutationKey: claimNextWorkerCharacterFactComparisonBatchMutationKey(options)
    };
    return mutationOptions;
};
 ...
 */
export const updateSettingCandidateGroupCharacterMatchMutation = (options?: Partial<Options<UpdateSettingCandidateGroupCharacterMatchData>>): UseMutationOptions<UpdateSettingCandidateGroupCharacterMatchResponse, UpdateSettingCandidateGroupCharacterMatchError, Options<UpdateSettingCandidateGroupCharacterMatchData>> => {
    const mutationOptions: UseMutationOptions<UpdateSettingCandidateGroupCharacterMatchResponse, UpdateSettingCandidateGroupCharacterMatchError, Options<UpdateSettingCandidateGroupCharacterMatchData>> = {
        mutationFn: async (fnOptions) => {
 ...
 * 개인 이미지 썸네일 암호문 조회
 */
export const getPrivateWorldImageThumbnailOptions = (options: Options<GetPrivateWorldImageThumbnailData>) => queryOptions<GetPrivateWorldImageThumbnailResponse, DefaultError, GetPrivateWorldImageThumbnailResponse, ReturnType<typeof getPrivateWorldImageThumbnailQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 * 개인 이미지 암호문 조회
 */
export const getPrivateWorldImageContentOptions = (options: Options<GetPrivateWorldImageContentData>) => queryOptions<GetPrivateWorldImageContentResponse, DefaultError, GetPrivateWorldImageContentResponse, ReturnType<typeof getPrivateWorldImageContentQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 * 회차 업로드 정책 조회
 *
 * 본인 작품의 단일 회차 분석 완료 수, 다회차 사용 가능 여부와 검토 대기 후보 수를 조회합니다.
 */
export const getEpisodeUploadPolicyOptions = (options: Options<GetEpisodeUploadPolicyData>) => queryOptions<GetEpisodeUploadPolicyResponse, GetEpisodeUploadPolicyError, GetEpisodeUploadPolicyResponse, ReturnType<typeof getEpisodeUploadPolicyQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getEpisodeUploadPolicy({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getEpisodeUploadPolicyQueryKey(options)
});
...
export const getMyFeedbackPromptQueryKey = (options?: Options<GetMyFeedbackPromptData>) => createQueryKey('getMyFeedbackPrompt', options);

/**
 * 서비스 의견 안내 대상 조회
 *
 * 활성 작품에 보관되지 않은 회차가 총 3개 이상이고, 의견 작성·안내 노출 기록이 없는 회원인지 조회합니다. 조회는 노출 기록을 변경하지 않습니다.
 */
export const getMyFeedbackPromptOptions = (options?: Options<GetMyFeedbackPromptData>) => queryOptions<GetMyFeedbackPromptResponse, GetMyFeedbackPromptError, GetMyFeedbackPromptResponse, ReturnType<typeof getMyFeedbackPromptQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getMyFeedbackPrompt({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getMyFeedbackPromptQueryKey(options)
});

export const getSignupPolicyQueryKey = (options?: Options<GetSignupPolicyData>) => createQueryKey('getSignupPolicy', options);

/**
 * 회원가입 인증 수단 조회
 */
export const getSignupPolicyOptions = (options?: Options<GetSignupPolicyData>) => queryOptions<GetSignupPolicyResponse, DefaultError, GetSignupPolicyResponse, ReturnType<typeof getSignupPolicyQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getSignupPolicy({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getSignupPolicyQueryKey(options)
});
...
export const getPendingWorkerWorldSettingSubjectResolutionsQueryKey = (options: Options<GetPendingWorkerWorldSettingSubjectResolutionsData>) => createQueryKey('getPendingWorkerWorldSettingSubjectResolutions', options);

/**
 * canonical 주체 해소가 필요한 세계관 후보 조회
 */
export const getPendingWorkerWorldSettingSubjectResolutionsOptions = (options: Options<GetPendingWorkerWorldSettingSubjectResolutionsData>) => queryOptions<GetPendingWorkerWorldSettingSubjectResolutionsResponse, DefaultError, GetPendingWorkerWorldSettingSubjectResolutionsResponse, ReturnType<typeof getPendingWorkerWorldSettingSubjectResolutionsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getPendingWorkerWorldSettingSubjectResolutions({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
 ...
 * 사용하지 않는 개인 이미지 삭제
 */
export const deletePrivateWorldImageMutation = (options?: Partial<Options<DeletePrivateWorldImageData>>): UseMutationOptions<DeletePrivateWorldImageResponse, DefaultError, Options<DeletePrivateWorldImageData>> => {
    const mutationOptions: UseMutationOptions<DeletePrivateWorldImageResponse, DefaultError, Options<DeletePrivateWorldImageData>> = {
        mutationFn: async (fnOptions) => {
