 ...
 */
export const updateWorldSettingCandidate = <ThrowOnError extends boolean = true>(options: Options<UpdateWorldSettingCandidateData, ThrowOnError>): RequestResult<UpdateWorldSettingCandidateResponses, UpdateWorldSettingCandidateErrors, ThrowOnError> => (options.client ?? client).patch<UpdateWorldSettingCandidateResponses, UpdateWorldSettingCandidateErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/works/{workId}/world-setting-candidates/{candidateId}',
    ...options,
    headers: {
