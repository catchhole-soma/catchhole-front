...
**1. 화면에 표시할 데이터**
- 회차 행: 회차 번호, 제목, 업로드일, 글자 수, 분석 상태, 충돌 의심 건수
- 업로드한 설정집: 제목 미리보기
...
- 회차별 충돌 의심 건수 — 현행 계약에 없어 충돌·리포트 계약과 함께 신설 필요 ([FE #27 리뷰](https://github.com/catchhole-soma/catchhole-front/pull/27#discussion_r3571290287)에서 제공 가능 확인). 이게 있어야 FE가 회차 행에 건수를 표시할 수 있음

**6. BE와 협의할 범위·상태값**
- 회차별 충돌 의심 건수는 일단 표시하는 방향 — 실사용에서 '없음' 남발·오탐 등 체감이 나쁘면 제외 재검토
