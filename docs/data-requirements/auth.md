...
**1. 화면에 표시할 데이터**
- 상단 고정 헤더: CatchHole 로고, 서비스 소개·주요 서비스 앵커, 로그인·무료 시작 보조 버튼, 데모 체험 주 버튼
...
- 데모 체험·로그인 없이 체험하기·먼저 체험해 보기 주 버튼 → 공개 [인터랙티브 데모](../screen-flow.md#2-인터랙티브-데모-wf-06)로 이동
